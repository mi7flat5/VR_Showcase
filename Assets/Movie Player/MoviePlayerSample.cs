...
public class MoviePlayerSample : MonoBehaviour
{
    ...
    private GvrAudioSource audioEmitter = null;
	...
	AndroidJavaObject StartVideoPlayerOnTextureId(int texWidth, int texHeight, string mediaPath)
	{
		...
		try
		{
		IntPtr setVolumeId = AndroidJNI.GetMethodID(mediaPlayer.GetRawClass(),"setVolume","(FF)V");
         jvalue[] arg = new jvalue[1];
        object[] args = new object[2];
        args[0] = 0.0;
        args[1] = 0.0;

        arg = AndroidJNIHelper.CreateJNIArgArray(args);
           ...
           AndroidJNI.CallVoidMethod(mediaPlayer.GetRawObject(), setVolumeId, arg);
